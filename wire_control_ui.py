...
class Ui_MainWindow(QMainWindow):
    ...
    def save_database(self):
        ...
        if self.pushButton_play.text() == "Ready":
            save = False
            while not save:
    ...
    def toggle_capture(self):
        if self.pushButton_play.text() == "Play":
            ...
            self.timer.start(10)
            self.pushButton_play.setText("Ready")
        else:
    ...
    def wire_predict(self):
        ...
        if radius:
            ...
            if r_cheliang:
                r_cl = min(r_cheliang)
                if r_cl <= min_radiu:
                    self.lineEdit_jieguo.setText('Fail')
                elif min_radiu < r_cl <= min_radiu + 10:
                    self.lineEdit_jieguo.setText('Warning')
                else:
                    self.lineEdit_jieguo.setText('Pass')
            else:
