...
def radius_predict(img,depth_image):
    # 将图像转换为灰度图像
    ...
    for i, branch in enumerate(branch_coords):
        ...
        l = len(branch) // 40  # ...............................................可以根据实际值进行修改
        # print(l)
        if l >= 3:
            for j in range(1, l - 1):
                dian_1 = branch[40 * (j - 1)]
                dian_2 = branch[40 * j]
                dian_3 = branch[40 * (j + 1)]
            ...
            dian_1 = branch[40 * (l - 2)]
            dian_2 = branch[40 * (l - 1)]
            dian_3 = branch[40 * l - 1]
            depth1 = depth_image[dian_1[1], dian_1[0]]
            depth2 = depth_image[dian_2[1], dian_2[0]]
            depth3 = depth_image[dian_3[1], dian_3[0]]
            # print(dian_1, dian_2, dian_3, depth1, depth2, depth3)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        depth_path = input('Input depth filename:')
